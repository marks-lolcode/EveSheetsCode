//FROM https://github.com/StarShip-Avalon-Projects/EveProjects/blob/main/FuzWorks.JS
//USES https://market.fuzzwork.co.uk/api/


function testing(){
  var testresult = testfuzAPI();
...
42830
  ...
  return fuzzPriceDataByHub(type_id,market_hub,order_type,order_level);
...
function fwalltest(){
    return fuzzPriceDataByHub("60003760","sell","max");
}
