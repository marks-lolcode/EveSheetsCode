...
function invImport(){
  var matImport = startImport("invTypes");  
}

function sdeMaterialsImport(){
  var matImport = startImport("materials");
}

function sdeProductsImport(){
  var matImport = startImport("products");
}

function sdeGroupsImport(){
  var matImport = startImport("groups");
}

function sdeAll(){
  var sdeAllFunctions = invImport();
  var sdeAllFunctions = sdeMaterialsImport();
  var sdeAllFunctions = sdeProductsImport();
  var sdeAllFunctions = sdeGroupsImport();
}
...
function startImport(importType){
  switch(importType){
    case "invTypes":
      var sName = "SDE_invTypes";
      var sdeName = "invTypes.csv";
      var sdeheaders =  ["typeID","groupID","typeName","volume"];
      break;
    case "materials":
      var sName = "SDE_Materials";
      var sdeName = "industryActivityMaterials.csv";
      var sdeheaders =  ["typeID","activityID","materialTypeID","quantity"];
      break;
    case "products":
      var sName = "SDE_Products";
      var sdeName = "industryActivityProducts.csv";
      var sdeheaders =  ["typeID","activityID","productTypeID","quantity"];
      break;
    case "groups":
      var sName = "SDE_Groups";
      var sdeName = "invGroups.csv";
      var sdeheaders =  ["groupID","categoryID","groupName","iconID","useBasePrice","anchored","anchorable","fittableNonSingleton","published"];
      break;
    default:
      throw error ("Invalid import type selected");
  }

  const sdePages = [
    new SdePage(sName,sdeName,sdeheaders)
  ];
